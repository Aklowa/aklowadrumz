import { version, ref, watchEffect, watch, getCurrentInstance, defineComponent, provide, createElementBlock, computed, h, inject, unref, shallowReactive, Suspense, nextTick, Transition, useSSRContext, hasInjectionContext, mergeProps, withCtx, createVNode, createApp, effectScope, reactive, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent } from 'vue';
...
const _routes = [
  {
    name: "blog-acrobatics",
    path: "/blog/acrobatics",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./acrobatics-CBTlvOKK.mjs').then((m) => m.default || m)
  },
  {
    name: "blog-dance",
    path: "/blog/dance",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./dance-C-Wt-oCQ.mjs').then((m) => m.default || m)
  },
  {
    name: "blog-history",
    path: "/blog/history",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./history-TeVIAh6T.mjs').then((m) => m.default || m)
  },
  {
    name: "blog-intEvents",
    path: "/blog/intEvents",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./intEvents-DthBYNni.mjs').then((m) => m.default || m)
  },
  {
    name: "blog-workshop",
    path: "/blog/workshop",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./workshop-Cy996BLM.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-ExY_dENr.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    useHead({
      title: "Aklowa Drum Band | Home",
      meta: [
        {
          name: "description",
          content: "This is the official website for Aklowa Drum Band."
        }
      ],
      bodyAttrs: {
        class: "test"
    ...
    useSeoMeta({
      ...
      ogTitle: "Aklowa Drum Band",
      description: "This is the official website for Aklowa Drum Band. Feel free to contact us for all your programs.",
      ogDescription: "This is the official website for Aklowa Drum Band. Feel free to contact us for all your programs.",
      // ogImage: "./assets/img/proper/aklowalogo.png",
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CXAIjV7R.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-Dy3YEfvh.mjs').then((r) => r.default || r));
...
export { useRouter as a, useRuntimeConfig as b, navigateTo as c, entry$1 as default, nuxtLinkDefaults as n, useHead as u };
