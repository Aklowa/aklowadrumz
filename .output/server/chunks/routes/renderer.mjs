...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"}],"link":[],"style":[],"script":[{"src":"https://identity.netlify.com/v1/netlify-identity-widget.js","defer":true}],"noscript":[],"title":"Aklowa Drum Band"};
