<template>
    ...
    <div class="bg-cover bg-center text-center overflow-hidden bg-[url(../../assets/img/ak_img/int_eent2.jpg)]"
    ...
    <div class="max-w-3xl mx-auto">
        <div
            ...
            <div class="bg-white relative top-0 -mt-32 p-5 sm:p-10">
                <h1 href="#" class="text-gray-900 font-bold text-3xl mb-2">International Events</h1>
    ...
    <div class="p-6 space-y-2">
      ...
      <p></p>
					...
					<div class="max-w-sm mx-auto group hover:no-underline focus:no-underline dark:bg-gray-50">
						<img role="presentation" class="object-cover w-full rounded h-44 dark:bg-gray-500" src="../../assets/img/ak_img/IMG-20240329-WA0011.jpg">
						<div class="p-6 space-y-2">
                            <h3 class="text-2xl font-semibold group-hover:underline group-focus:underline">Drum performance</h3>
							<span class="text-xs dark:text-gray-600">December 22, 2000</span>
							
						</div>
					</div>
					<div class="max-w-sm mx-auto group hover:no-underline focus:no-underline dark:bg-gray-50">
                        <img role="presentation" class="object-cover w-full rounded h-44 dark:bg-gray-500" src="../../assets/img/ak_img/Ben.jpg">
						<div class="p-6 space-y-2">
                            <h3 class="text-2xl font-semibold group-hover:underline group-focus:underline">At an international event</h3>
					...
					<div class="max-w-sm mx-auto group hover:no-underline focus:no-underline dark:bg-gray-50">
                        <img role="presentation" class="object-cover w-full rounded h-44 dark:bg-gray-500" src="../../assets/img/ak_img/int_eent.jpg">
						<div class="p-6 space-y-2">
                            <h3 class="text-2xl font-semibold group-hover:underline group-focus:underline">Dance performance in the UK</h3>
							<span class="text-xs dark:text-gray-600">January 23, 2002</span>
							
						</div>
					</div>
					<div class="max-w-sm mx-auto group hover:no-underline focus:no-underline dark:bg-gray-50">
                        <img role="presentation" class="object-cover w-full rounded h-44 dark:bg-gray-500" src="../../assets/img/ak_img/int_eent2.jpg">
						<div class="p-6 space-y-2">
                            <h3 class="text-2xl font-semibold group-hover:underline group-focus:underline">Dance performance in Italy</h3>
