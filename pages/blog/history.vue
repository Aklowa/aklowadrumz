<template>
    ...
    <div class="bg-cover bg-center text-center overflow-hidden bg-[url(../../assets/img/proper/fel.jpg)]"
    ...
    <div class="max-w-3xl mx-auto">
        <div
            ...
            <div class="bg-white relative top-0 -mt-32 p-5 sm:p-10">
                <h1 href="#" class="text-gray-900 font-bold text-3xl mb-2">History of Aklowa Drum Band</h1>
            ...
            <div class="container  p-6 space-y-6 sm:space-y-12">
                ...
                <div class="grid justify-center grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
					...
					<div class="max-w-sm mx-auto group hover:no-underline focus:no-underline dark:bg-gray-50">
						<img role="presentation" class="object-cover w-full rounded h-44 dark:bg-gray-500" src="../../assets/img/proper/fel.jpg">
						<div class="p-6 space-y-2">
                            <h3 class="text-2xl font-semibold group-hover:underline group-focus:underline">Felix Cobson (late)</h3>
							<span class="text-xs dark:text-gray-600">December 22, 2000</span>
							
						</div>
					</div>
					<div class="max-w-sm mx-auto group hover:no-underline focus:no-underline dark:bg-gray-50">
                        <img role="presentation" class="object-cover w-full rounded h-44 dark:bg-gray-500" src="../../assets/img/proper/W2-1.jpg">
						<div class="p-6 space-y-2">
                            <h3 class="text-2xl font-semibold group-hover:underline group-focus:underline">Performance with the founder</h3>
					...
					<div class="max-w-sm mx-auto group hover:no-underline focus:no-underline dark:bg-gray-50">
						...
						<div class="p-6 space-y-2">
                            <h3 class="text-2xl font-semibold group-hover:underline group-focus:underline">Performance in the UK to welcome Queen Elizabeth II and the minister of finance</h3>
							<span class="text-xs dark:text-gray-600">December 22, 2000</span>
							
						</div>
					</div>
					<div class="max-w-sm mx-auto group hover:no-underline focus:no-underline dark:bg-gray-50">
                        <img role="presentation" class="object-cover w-full rounded h-44 dark:bg-gray-500" src="../../assets/img/ak_img/IMG-20240325-WA0004.jpg">
						<div class="p-6 space-y-2">
                            <h3 class="text-2xl font-semibold group-hover:underline group-focus:underline">Dance performance in Ghana</h3>
							<span class="text-xs dark:text-gray-600">January 23, 2002</span>
							
						</div>
					</div>
					<div class="max-w-sm mx-auto group hover:no-underline focus:no-underline dark:bg-gray-50">
                        <img role="presentation" class="object-cover w-full rounded h-44 dark:bg-gray-500" src="../../assets/img/ak_img/IMG-20240312-WA0009.jpg">
						<div class="p-6 space-y-2">
                            <h3 class="text-2xl font-semibold group-hover:underline group-focus:underline">A musical album composed with the founder.</h3>
							<span class="text-xs dark:text-gray-600">January 23, 2022</span>
