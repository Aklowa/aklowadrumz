<template>
    ...
    <div class="bg-cover bg-center text-center overflow-hidden bg-[url(../../assets/img/ak_img/org.jpg)]"
    ...
    <div class="max-w-3xl mx-auto">
        <div
            ...
            <div class="bg-white relative top-0 -mt-32 p-5 sm:p-10">
                <h1 href="#" class="text-gray-900 font-bold text-3xl mb-2">African Dance Events</h1>
                ...
                <p class="text-base leading-8 my-5">
                    The Aklowa Drum Band isn't just a musical ensemble; they're a vibrant force keeping traditional Ghanaian dance alive. Led by the creative energy of Benjamin Borketey, the Aklowa troupe blends high-octane drumming with over 200 meticulously preserved dance movements.
                </p>
                ...
                <p class="text-base leading-8 my-5">
                    Aklowa's dedication extends beyond their own performances.  They participate in festivals and cultural gatherings, sharing their passion and knowledge with a wider audience.  Their infectious enthusiasm ensures that these traditional dances, passed down through generations, continue to captivate hearts and inspire movement.
                </p>
            ...
            <div class="container  p-6 space-y-6 sm:space-y-12">
                ...
                <div class="grid justify-center grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
					...
					<div class="max-w-sm mx-auto group hover:no-underline focus:no-underline dark:bg-gray-50">
                        ...
                        <div class="p-6 space-y-2">
                            <h3 class="text-2xl font-semibold group-hover:underline group-focus:underline">Traditional Dance</h3>
                            <span class="text-xs dark:text-gray-600">May 21, 2022</span>
                            <p></p>
                        </div>
                        </div>
					<div class="max-w-sm mx-auto group hover:no-underline focus:no-underline dark:bg-gray-50">
						<img role="presentation" class="object-cover w-full rounded h-44 dark:bg-gray-500" src="../../assets/img/ak_img/org2.jpg">
						<div class="p-6 space-y-2">
                            <h3 class="text-2xl font-semibold group-hover:underline group-focus:underline">Performance with Felix Cobson</h3>
							<span class="text-xs dark:text-gray-600">December 22, 2000</span>
							
						</div>
					</div>
					<div class="max-w-sm mx-auto group hover:no-underline focus:no-underline dark:bg-gray-50">
                        <img role="presentation" class="object-cover w-full rounded h-44 dark:bg-gray-500" src="../../assets/img/ak_img/int_eent3.jpg">
						<div class="p-6 space-y-2">
                            <h3 class="text-2xl font-semibold group-hover:underline group-focus:underline">Performance to welcome Queen Elizabeth</h3>
