<template>
	<footer class="px-4 divide-y dark:bg-blue-100 dark:text-gray-800">
		<div class="container flex flex-col justify-between py-1 mx-auto space-y-8 lg:flex-row lg:space-y-0">
			<div class="lg:w-1/3">
				<a rel="noopener noreferrer" href="#" class="flex justify-center space-x-3 lg:justify-start">
					<div class="flex items-center justify-center w-25 h-25 rounded-full ">
                        <img class="h-20" src="../../assets/img/proper/aklowa_logo.svg" alt="Aklowa Logo" />
					</div>
					<span class="self-center text-2xl font-semibold">Aklowa Drum Band</span>
				</a>
			</div>
			<div class="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
				...
				<div class="space-y-3 col-end-7 col-span-2">
		...
		<div class="py-3 text-sm text-center ">© 2024 Aklowa Drum Band. All rights reserved.</div>
	</footer>
</template>